// database.js - Thailand Ultimate Guide Data
// Prijzen zijn in THB (Thaise Baht)

const locations = [
    // SIGHTS (Top 50)
    { id: 101, rank: 1, type: 'sight', tag: 'culture', region: 'bangkok', name: "The Grand Palace", lat: 13.7500, lng: 100.4915, price_thb: 500, desc: "Het officiële verblijf van de koningen van Siam." },
    ...
    { id: 134, rank: 34, type: 'sight', tag: 'culture', region: 'north', name: "Wat Chedi Luang", lat: 18.7870, lng: 98.9866, price_thb: 40, desc: "Grote ruïne-stoepa in het centrum van Chiang Mai." },
    ...
    { id: 204, rank: 4, type: 'food', tag: 'culture', region: 'bangkok', name: "Sühring", lat: 13.7205, lng: 100.5440, price_thb: 7500, desc: "Moderne Duitse topgastronomie in een tropische villa." },
    ...
    { id: 207, rank: 7, type: 'food', tag: 'culture', region: 'bangkok', name: "Le Du", lat: 13.7230, lng: 100.5290, price_thb: 4500, desc: "Moderne Thaise gerechten op basis van seizoensingrediënten." },
    ...
    { id: 210, rank: 10, type: 'food', tag: 'culture', region: 'bangkok', name: "Gaa", lat: 13.7320, lng: 100.5790, price_thb: 4700, desc: "Innovatieve Indiase smaken met lokale Thaise ingrediënten." },
    ...
    { id: 216, rank: 16, type: 'food', tag: 'culture', region: 'bangkok', name: "Côte by Mauro Colagreco", lat: 13.7127, lng: 100.5132, price_thb: 6500, desc: "Riviera-geïnspireerde keuken aan de Chao Phraya." },
    ...
    { id: 220, rank: 20, type: 'food', tag: 'culture', region: 'bangkok', name: "Maison Dunand", lat: 13.7229, lng: 100.5262, price_thb: 4900, desc: "Klassieke Franse keuken geïnspireerd door de Alpen." },
    ...
    { id: 227, rank: 27, type: 'food', tag: 'culture', region: 'bangkok', name: "80/20", lat: 13.7297, lng: 100.5161, price_thb: 3500, desc: "Innovatieve Thaise keuken met lokale ingrediënten." },
    ...
    { id: 238, rank: 38, type: 'food', tag: 'culture', region: 'south', name: "L'Arôme by the Sea", lat: 7.9152, lng: 98.2932, price_thb: 4500, desc: "Franse gastronomie met uitzicht op de Andamanse Zee." },
    ...
    { id: 240, rank: 40, type: 'food', tag: 'culture', region: 'north', name: "Blackitch Artisan Kitchen", lat: 18.7980, lng: 98.9695, price_thb: 2590, desc: "Ambachtelijke keuken met fermentatie en lokale ingrediënten." },
    { id: 241, rank: 41, type: 'food', tag: 'culture', region: 'north', name: "Cuisine de Garden", lat: 18.7429, lng: 98.9282, price_thb: 2000, desc: "Op de natuur geïnspireerde gerechten (Chiang Mai)." },
    ...
    { id: 319, rank: 19, type: 'activity', tag: 'culture', region: 'bangkok', name: "Khlong Boottocht", lat: 13.7622, lng: 100.4735, price_thb: 800, desc: "Verken het 'Venetië van het Oosten'." },
    ...
    { id: 323, rank: 23, type: 'activity', tag: 'culture', region: 'south', name: "Cabaret Show", lat: 12.9493, lng: 100.8884, price: "€ 1000", desc: "Spectaculaire ladyboy show." },
    { id: 324, rank: 24, type: 'activity', tag: 'nature', region: 'south', name: "Kitesurfen Hua Hin", lat: 12.5500, lng: 99.9600, price: "€ 1500", desc: "Leer kitesurfen op de beste windplek." },
    { id: 325, rank: 25, type: 'activity', tag: 'culture', region: 'east', name: "Fruit Carving", lat: 13.7200, lng: 100.5200, price: "€ 1200", desc: "Leer de koninklijke kunst van fruit snijden." },
    { id: 326, rank: 26, type: 'activity', tag: 'nature', region: 'south', name: "Yoga Retreat", lat: 9.7500, lng: 100.0000, price: "€ 400", desc: "Yoga op Koh Phangan." },
    { id: 327, rank: 27, type: 'activity', tag: 'culture', region: 'bangkok', name: "Blind Massage", lat: 13.7240, lng: 100.5280, price: "€ 350", desc: "Massage door blinde therapeuten." },
    { id: 328, rank: 28, type: 'activity', tag: 'nature', region: 'south', name: "Wakeboarden", lat: 13.9575, lng: 100.7300, price: "€ 1000", desc: "Wereldklasse cable park." },
    { id: 329, rank: 29, type: 'activity', tag: 'nature', region: 'north', name: "Zipline", lat: 18.8500, lng: 99.1000, price: "€ 3000", desc: "Zweef door het oerwoud." },
    { id: 330, rank: 30, type: 'activity', tag: 'culture', region: 'bangkok', name: "Muay Thai Kijken", lat: 13.8690, lng: 100.6010, price: "€ 2000", desc: "Ervaar de sfeer in het Lumpinee stadion." },
    ...
    { id: 333, rank: 33, type: 'activity', tag: 'nature', region: 'west', name: "SUP Boarden", lat: 14.0400, lng: 99.5000, price: "€ 600", desc: "Paddleboarden over de River Kwai." },
    { id: 334, rank: 34, type: 'activity', tag: 'culture', region: 'north', name: "Keramiek Workshop", lat: 18.7500, lng: 99.0000, price: "€ 1000", desc: "Maak je eigen Celadon-aardewerk." },
    { id: 335, rank: 35, type: 'activity', tag: 'nature', region: 'south', name: "Snorkelen Koh Lipe", lat: 6.4884, lng: 99.3039, price: "€ 800", desc: "Snorkelen vanaf het strand." },
    { id: 336, rank: 36, type: 'activity', tag: 'culture', region: 'bangkok', name: "Rooftop Bar", lat: 13.7224, lng: 100.5800, price: "€ 500", desc: "Cocktails met uitzicht." },
    ...
    { id: 338, rank: 38, type: 'activity', tag: 'culture', region: 'north', name: "Thee Plukken", lat: 20.1667, lng: 99.6167, price: "€ 200", desc: "Pluk Oolong thee in Doi Mae Salong." },
    { id: 339, rank: 39, type: 'activity', tag: 'nature', region: 'south', name: "Inktvis Vissen", lat: 12.5000, lng: 101.5000, price: "€ 800", desc: "Nachtvissen op zee." },
    ...
    { id: 341, rank: 41, type: 'activity', tag: 'culture', region: 'north', name: "Saa Papier Maken", lat: 18.7700, lng: 99.0500, price: "€ 300", desc: "Maak papier van boomschors." },
    { id: 342, rank: 42, type: 'activity', tag: 'nature', region: 'west', name: "Olifantenbad", lat: 14.1000, lng: 99.4000, price: "€ 2000", desc: "Zie olifanten spelen in de rivier." },
    { id: 343, rank: 43, type: 'activity', tag: 'culture', region: 'bangkok', name: "Midnight Food Tour", lat: 13.7500, lng: 100.5000, price: "€ 2200", desc: "TukTuk tour langs eettentjes." },
    { id: 344, rank: 44, type: 'activity', tag: 'nature', region: 'south', name: "Schildpadden Opvang", lat: 8.5000, lng: 98.2500, price: "€ 100", desc: "Bezoek het conservatiecentrum." },
    ...
    { id: 346, rank: 46, type: 'activity', tag: 'nature', region: 'north', name: "Rijst Planten", lat: 19.0000, lng: 98.5000, price: "€ 500", desc: "Leer rijst planten in de modder." },
    { id: 347, rank: 47, type: 'activity', tag: 'culture', region: 'south', name: "Schaduwpoppenspel", lat: 8.4300, lng: 99.9600, price: "€ 200", desc: "Traditioneel theater in het zuiden." },
    ...
    { id: 350, rank: 50, type: 'activity', tag: 'culture', region: 'bangkok', name: "Muang Boran Fietsen", lat: 13.5390, lng: 100.6226, price: "€ 700", desc: "Fiets door 'The Ancient City'." },
